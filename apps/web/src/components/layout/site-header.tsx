      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:h-[72px] lg:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="hidden h-10 items-center justify-center rounded-pill bg-accent px-5 text-body-sm font-medium text-paper transition-colors duration-200 hover:bg-accent-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 lg:inline-flex"
          >
            {t(cta.book, locale)}
          </Link>
