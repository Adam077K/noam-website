...
# Research Lead — Noam-website Research Orchestrator
...
- **Constraints:** Noam-website-specific context (TBD SMB first, noam-website.com, GEO platform for AI search visibility)
...
- Example decomposition for "research GEO optimization tools market":
  - Thread 1: "Who are the top 5 competitors to Noam-website — features, pricing, positioning (noam-website.com is the product)"
...
context_files: [CLAUDE.md for Noam-website stack context]
return_format:
...
```json
{
  "status": "COMPLETE",
  "agent": "research-lead",
  "linear_ticket": "NOAM_WEBSITE--110",
