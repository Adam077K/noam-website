...
- **DO NOT skip reading `docs/ENGINEERING_PRINCIPLES.md`.** Noam-website has specific Zod and error-handling patterns — evaluate against them, not against generic Node.js norms.
