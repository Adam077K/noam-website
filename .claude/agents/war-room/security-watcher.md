...
- **Findings day**: 1 Linear ticket (label: `agent:security-watcher`)
  ...
  - Body structure:
    ...
    ```
- **P0 escalation** (any of these triggers Telegram via notify.noam-website.com AND a HIGH ticket):
...
13. If P0 finding: POST notify.noam-website.com/telegram with P0 alert message
...
- DO NOT recommend actions Adam cannot execute (no "contact your cloud provider" type recommendations — be specific to the Noam-website stack)
