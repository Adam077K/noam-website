...
| `geo-algorithm-signal.md` | Weekly GEO algorithm trend report from Noam-website scan data | claude-opus-4-7 | Sunday 10:30 (`30 10 * * 0`) — Q4 moved from 05:45 | $2.50 |
...
| Q12 | Add ai-search-rank-tracker | NO — defer (Noam-website product itself will track this in future) |
