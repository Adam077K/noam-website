...
skills:
  - ui-visual-validator
  - noam-website-brand-quality-bar
  - wcag-audit-patterns
...
Evaluate against Noam-website's billion-dollar craft standard:
...
8. **Generic detection:** Does this look like it could be any SaaS dashboard, or does it have Noam-website character?
...
- Generic elements that lack Noam-website character
...
```json
{
  "status": "COMPLETE",
  "agent": "design-critic",
  "linear_ticket": "NOAM_WEBSITE--224",
  "verdict": "NEEDS_WORK",
...
- **DO NOT skip the mobile screenshot.** Half the SMB owners using Noam-website are on mobile. Missing mobile review is an incomplete review.
