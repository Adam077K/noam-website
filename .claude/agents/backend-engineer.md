...
# "feat(api): rate-limit free scans (NOAM_WEBSITE--104)"
```
...
```json
{
  ...
  "commits": [
    "feat(api): rate-limit free scans to 5 per IP per hour (NOAM_WEBSITE--104)",
...
|---|---|
| Touching `apps/web/supabase/migrations/` or RLS | `supabase-rls-noam-website` |
