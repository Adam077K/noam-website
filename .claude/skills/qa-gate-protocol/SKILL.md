...
description: "Noam-website's 4-tier QA gate: Trivial/Lite/Full/Irreversible classification, reviewer assignment, evaluator-optimizer pattern, multi-judge setup, Codex CLI graceful degradation, and bypass rules. Use when QA-Lead is classifying a PR or CTO is routing a task to the correct tier."
tags: [quality, noam-website-specific, testing, security]
