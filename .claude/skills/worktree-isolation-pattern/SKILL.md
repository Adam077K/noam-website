...
description: "The exact git worktree create, detect, and clean pattern for Noam-website workers: detect-or-create from main-repo-root, child worktree commands, branch naming conventions (feat/fix/chore), atomic commits, and .worktrees/ gitignore enforcement."
tags: [git, noam-website-specific, workflow, workers]
source: noam-website-authored 2026-05-16
risk: low
---
...
# /Users/adamks/VibeCoding/Noam-website                      abc1234 [main]
# /Users/adamks/VibeCoding/Noam-website/.worktrees/ceo-1-xxx  def5678 [ceo-1-xxx]
...
pnpm -F @noam-website/web exec tsc --noEmit apps/web/src/app/api/scan/route.ts

# Lint
pnpm -F @noam-website/web lint --max-warnings 0
```
...
# Run relevant tests
pnpm -F @noam-website/web test -- --testPathPattern="scan"
...
```json
{
  ...
  "worktree": "/Users/adamks/VibeCoding/Noam-website/.worktrees/scan-rate-limit",
  "files_changed": [
