...
description: "The Noam-website 4-round board-meeting protocol: R0 framing, R1 independent verdicts, R2 cross-critique, R3 fresh-context synthesis. Includes JSON output schema per round, persona routing rules, and Zod validation requirements. Use for any strategic or irreversible decision."
tags: [orchestration, noam-website-specific, strategy, decision-making]
