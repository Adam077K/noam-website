...
description: "Noam-website's locked Linear label vocabulary, sub-ticket creation pattern, and single-synthesis-comment style. Use whenever any CEO or C-suite agent interacts with Linear tickets, creates sub-tickets, or posts comments."
tags: [workflow, noam-website-specific, linear, orchestration]
...
await linear.createComment({
  ...
  body: `---NOAM_WEBSITE--SPEC-V1-START---\n${JSON.stringify(spec, null, 2)}\n---NOAM_WEBSITE--SPEC-V1-END---`,
});
```
...
```
Noam-website — Main (product work)        ← Adam and agents work here
Noam-website — War Room (orchestration)   ← Standing Routines post here, separate from product
Noam-website — Strategy (board meetings)  ← Board meeting outputs
```
