...
description: "How to write a Noam-website Routine .md file: required frontmatter fields (schedule, routine_id_env_key, budget, trust-spec parsing), body conventions, and MCP grant patterns. Use when authoring or refining any file under .claude/agents/_routines/."
tags: [orchestration, noam-website-specific, agents, routines]
...
1. Extract spec from `---NOAM_WEBSITE--SPEC-V1-START---` / `---NOAM_WEBSITE--SPEC-V1-END---` sentinels
