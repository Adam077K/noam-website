...
description: "Querying Noam-website's five RAG corpora stored in Supabase pgvector: DECISIONS, sessions, codebase, brain, and skills. Use when any CEO, CTO, or Research-Lead agent needs semantic search over internal knowledge during pre-flight or research."
tags: [rag, noam-website-specific, database, ai, memory]
