export const meta = {
  name: 'design',
  description: 'Noam-website T5 design workflow — generates N independent design variations from different angles, scores each with parallel design-critic judges against the brand bar, and synthesizes a winning direction (grafting the best ideas from runners-up). Optimizes for craft/quality, not speed.',
  phases: [
...
const judged = await pipeline(
  ...
  (variation) => variation
    ? agent(
        `Score this Noam-website design variation against the brand quality bar and the brief.
Brief: ${BRIEF}
...
const synthesis = await agent(
  `Synthesize the final Noam-website design direction for: ${TARGET}.
Brief: ${BRIEF}
