...
git commit -m "feat(ui/scan): add ScanResultCard with loading/empty/error/success states (NOAM_WEBSITE--107)"
```
...
```json
{
  ...
  "linear_ticket": "NOAM_WEBSITE--107",
  ...
  "commits": [
    "feat(ui/scan): add ScanResultCard with all 4 states and mobile-first layout (NOAM_WEBSITE--107)"
  ],
