...
- Today's GitHub commits (last 24h): `mcp__github__list_commits({owner: "Adam077K", repo: "Noam-website", since: "TODAY_ISO_START", until: "TODAY_ISO_END", per_page: 30})` — replace TODAY_ISO_START/END with start/end of current calendar day UTC
