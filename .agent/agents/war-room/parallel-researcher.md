...
4. **Mem0 prior research** — via `mcp__mem0__search`: query with the core topic of the research question. If Noam-website has already researched this topic, surface what was found and when. This avoids redundant research and connects new findings to existing context.
