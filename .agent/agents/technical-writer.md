...
2. `CLAUDE.md` — Noam-website stack, Supabase table names, file path conventions
...
git commit -m "docs(api): add scan/start reference doc (NOAM_WEBSITE--212)"
```
...
```json
{
  ...
  "linear_ticket": "NOAM_WEBSITE--212",
  ...
  "commits": [
    "docs(api): add scan/start reference doc with rate-limit error codes (NOAM_WEBSITE--212)"
  ],
