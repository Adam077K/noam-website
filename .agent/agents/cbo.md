...
```json
{
  "status": "COMPLETE",
  "agent": "cbo",
  "linear_ticket": "NOAM_WEBSITE--112",
  "numbers_table": [
...
- **DO NOT reference Stripe.** Noam-website uses Paddle exclusively. All payment references use Paddle terminology (price_id, subscription, webhook).
