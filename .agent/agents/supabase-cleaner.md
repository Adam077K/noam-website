...
description: "Worker. Audits the Noam-website Supabase project against post-rethink schema. Never runs destructive SQL — emits reviewed SQL plan files for Adam to apply manually. Spawned by CEO or CTO."
...
1. `CLAUDE.md` — Noam-website stack, table name conventions (e.g., `your_results_table` not `scan_engine_responses`)
...
```json
{
  ...
  "linear_ticket": "NOAM_WEBSITE--231",
