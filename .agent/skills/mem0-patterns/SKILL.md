...
description: "Mem0 episodic memory write/read patterns for Noam-website agents: mandatory metadata fields, retry policy, and fallback to Anthropic Memory Tool after 3 failures. Use when any C-suite or lead agent reads or writes episodic memory during pre-flight or post-task."
tags: [memory, noam-website-specific, agents, ai]
...
Every Mem0 write MUST include all four fields. Writes missing any of these are rejected by the Noam-website wrapper.
...
- `pgvector-rag-noam-website` — [[pgvector-rag-noam-website]]
