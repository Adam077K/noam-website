...
description: "Noam-website billing patterns using Paddle: webhook signature verification, checkout session creation, customer portal URL generation, price ID conventions, and subscription lifecycle. Stripe is not used — Paddle is the only payment provider."
tags: [billing, noam-website-specific, backend, payments]
...
- Stripe is not in the Noam-website stack. Any Stripe reference is legacy and should be removed.
...
- `supabase-rls-noam-website` — [[supabase-rls-noam-website]]
