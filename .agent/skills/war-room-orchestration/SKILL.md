...
description: "How CEO and C-suite dispatch work through the Noam-website war-room trust-spec system: Linear label routing, Cloudflare bridge, HMAC-signed specs, fan-out/fan-in via Inngest, and audit_log enforcement. Use when authoring or debugging any CEO/C-suite dispatch flow."
tags: [orchestration, noam-website-specific, agents, war-room]
